  ...
  return (
    <Router>
      ...
      <div className="min-h-screen bg-brand-bg text-brand-secondary selection:bg-brand-primary/20 selection:text-brand-secondary">
        <Header />
        <main className="pb-10 px-6 max-w-[1600px] mx-auto min-h-screen">
          <Routes>
            ...
            <Route path="/forgot-password" element={!user ? <ForgotPasswordPage /> : <Navigate to={`/${user.role.toLowerCase()}`} />} />
